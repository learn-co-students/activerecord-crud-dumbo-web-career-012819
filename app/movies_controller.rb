...
def can_be_instantiated_and_then_saved
  movie = Movie.new({title: "stuff", release_date: 20, director: "dumb dumb", lead: "Sinatra", in_theaters: true})
...
def can_be_found_updated_and_saved
  ...
  just_awesome = Movie.find_by(title: "Awesome Flick")
  just_awesome.title = "Even Awesomer Flick"
  just_awesome.save
end
